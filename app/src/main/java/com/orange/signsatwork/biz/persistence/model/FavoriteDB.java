...
// we want to save 'Favorite' objects in the 'favorites' DB table
...
public class FavoriteDB {
    ...
    @JoinTable(name = "favorites_videos", joinColumns = @JoinColumn(name = "favorites_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "videos_id", referencedColumnName = "id"))
    @JsonManagedReference
    @Fetch(value = FetchMode.SUBSELECT)
    private List<VideoDB> videos = new ArrayList<>();

    @ManyToMany(fetch = FetchType.LAZY)
    @JoinTable(name = "favorites_communities", joinColumns = @JoinColumn(name = "favorites_id", referencedColumnName = "id"),
