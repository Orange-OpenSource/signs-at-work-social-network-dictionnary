...
public class RestApi {
  ...
  public static final String WS_SEC_CREATE_LABEL_ADD_SIGN = WS_SEC + "label/create_label_add_sign/{signId}";
  ...
  public static final String WS_SEC_FAVORITES_FOR_FILTER = WS_SEC + "favoritesForFilter";
  ...
  public static final String WS_SEC_COMMENT = WS_SEC + "signs/{signId}/videos/{videoId}/comments/{commentId}";
