...
import com.orange.signsatwork.biz.view.model.ComparableVideo;
...
public class VideoView  {
  private long signId;
  private String signTextDefinition;
  private String signVideoDefinition;
  private long videoId;
  private String videoName;
  private String url;
  private boolean isVideoCreatedByMe;
  private boolean isVideoHasAveragePositiveRate;
  private boolean isVideoBelowToFavorite;
  private RatingData ratingData;
  private List<CommentData> commentDatas;
  private Long nbRating;
  private List<VideoHistoryData> videoHistoryDatas;
