...
public class TestUIController {
  ...
  public String user(@RequestParam("fileVideoName") MultipartFile fileVideoName, @RequestParam("fileVideoJob") MultipartFile fileVideoJob,  @ModelAttribute UserCreationView userCreationView, Model model) throws IOException, JCodecException {
