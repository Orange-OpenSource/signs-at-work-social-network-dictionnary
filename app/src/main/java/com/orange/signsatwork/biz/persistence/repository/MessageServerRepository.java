...
public interface MessageServerRepository extends CrudRepository<MessageServerDB, Long> {
  ...
  @Query("select distinct m FROM MessageServerDB m where m.type in ('UpdateRequestDescriptionMessage','UpdateRequestDescriptionSendEmailMessage', 'AddRequestDescriptionMessage', 'AddRequestDescriptionSendEmailMessage', 'DeleteRequestDescriptionMessage', 'DeleteRequestDescriptionSendEmailMessage', 'AddRequestDescriptionTextSendEmailMessage', 'UpdateRequestDescriptionTextSendEmailMessage', 'DeleteRequestSendEmailMessage', 'DeleteRequestMessage')  order by m.date asc")
  List<MessageServerDB> findMessagesServerDataRequestAsc();

  @Query("select distinct m FROM MessageServerDB m where m.type in ('UpdateRequestDescriptionMessage','UpdateRequestDescriptionSendEmailMessage', 'AddRequestDescriptionMessage', 'AddRequestDescriptionSendEmailMessage', 'DeleteRequestDescriptionMessage', 'DeleteRequestDescriptionSendEmailMessage', 'AddRequestDescriptionTextSendEmailMessage', 'UpdateRequestDescriptionTextSendEmailMessage', 'DeleteRequestSendEmailMessage', 'DeleteRequestMessage')  order by m.date desc")
