...
public interface MessageServerRepository extends CrudRepository<MessageServerDB, Long> {
  ...
  @Query("select distinct m FROM MessageServerDB m where m.type in ('UpdateCommunityDescriptionMessage', 'UpdateCommunityDescriptionSendEmailMessage', 'AddCommunityDescriptionMessage', 'AddCommunityDescriptionSendEmailMessage', 'DeleteCommunityDescriptionMessage', 'DeleteCommunityDescriptionSendEmailMessage', 'UpdateCommunityDescriptionTextMessage', 'UpdateCommunityDescriptionTextSendEmailMessage', 'AddCommunityDescriptionTextMessage=', 'AddCommunityDescriptionTextSendEmailMessage', 'CreateProjectCommunityMessage', 'CreateProjectCommunitySendEmailMessage', 'CreateJobCommunityMessage', 'CommunityCreateMessage', 'CommunityRenameMessage', 'RenameCommunitySendEmailMessage', 'RenameCommunityMessage', 'CommunityDeleteSendEmailMessage', 'CommunityDeleteMessage', 'DeleteCommunityMessageWithoutUsers', 'DeleteCommunityMessage', 'DeleteCommunitySendEmailMessage','CommunityAddDescriptionMessage', 'CommunityRemoveMessage', 'UsersRemoveToCommunitySendEmailMessage', 'UsersRemoveToCommunityMessage', 'CommunityRemoveMeMessage', 'UserRemoveMeCommunityMessage', 'CommunityAddMessage', 'UsersAddToCommunitySendEmailMessage', 'UsersAddToCommunityMessage') order by m.date asc")
  List<MessageServerDB> findMessagesServerCommunityActionAsc();

  @Query("select distinct m FROM MessageServerDB m where m.type in ('UpdateCommunityDescriptionMessage', 'UpdateCommunityDescriptionSendEmailMessage', 'AddCommunityDescriptionMessage', 'AddCommunityDescriptionSendEmailMessage', 'DeleteCommunityDescriptionMessage', 'DeleteCommunityDescriptionSendEmailMessage', 'UpdateCommunityDescriptionTextMessage', 'UpdateCommunityDescriptionTextSendEmailMessage', 'AddCommunityDescriptionTextMessage=', 'AddCommunityDescriptionTextSendEmailMessage', 'CreateProjectCommunityMessage', 'CreateProjectCommunitySendEmailMessage', 'CreateJobCommunityMessage', 'CommunityCreateMessage', 'CommunityRenameMessage', 'RenameCommunitySendEmailMessage', 'RenameCommunityMessage', 'CommunityDeleteSendEmailMessage', 'CommunityDeleteMessage', 'DeleteCommunityMessageWithoutUsers', 'DeleteCommunityMessage', 'DeleteCommunitySendEmailMessage', 'CommunityAddDescriptionMessage', 'CommunityRemoveMessage', 'UsersRemoveToCommunitySendEmailMessage', 'UsersRemoveToCommunityMessage','CommunityRemoveMeMessage', 'UserRemoveMeCommunityMessage', 'CommunityAddMessage', 'UsersAddToCommunitySendEmailMessage', 'UsersAddToCommunityMessage') order by m.date desc")
