...
public interface MessageServerRepository extends CrudRepository<MessageServerDB, Long> {
  ...
  @Query("select distinct m FROM MessageServerDB m where m.type in ('CreatePasswordMessage', 'CreatePasswordMessageAfterChangeEmailMessage', 'SavePasswordMessage', 'UserDeleteMessage', 'UserLockMessage', 'UserUnLockMessage') order by m.date asc")
  List<MessageServerDB> findMessagesServerUserProfilActionAsc();

  @Query("select distinct m FROM MessageServerDB m where m.type in ('CreatePasswordMessage', 'CreatePasswordMessageAfterChangeEmailMessage', 'SavePasswordMessage','UserDeleteMessage', 'UserLockMessage', 'UserUnLockMessage') order by m.date desc")
