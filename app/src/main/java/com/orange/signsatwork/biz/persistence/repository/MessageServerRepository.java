...
public interface MessageServerRepository extends CrudRepository<MessageServerDB, Long> {
  ...
  @Query("select distinct m FROM MessageServerDB m where m.type in ('CreateJobCommunityMessage', 'CommunityCreateMessage', 'CommunityRenameMessage', 'CommunityDeleteMessage', 'CommunityAddDescriptionMessage', 'CommunityRemoveMessage', 'CommunityRemoveMeMessage', 'CommunityAddMessage') order by m.date asc")
  List<MessageServerDB> findMessagesServerCommunityActionAsc();

  @Query("select distinct m FROM MessageServerDB m where m.type in ('CreateJobCommunityMessage', 'CommunityCreateMessage', 'CommunityRenameMessage', 'CommunityDeleteMessage', 'CommunityAddDescriptionMessage', 'CommunityRemoveMessage', 'CommunityRemoveMeMessage', 'CommunityAddMessage') order by m.date desc")
